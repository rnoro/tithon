...
case "${1:-a}" in
  ...
  c) scripts="v7 v9 v17 v27 v31"; label="VERIFY-C" ;;   # client restore + backpressure + per-file kernels + rich outputs + live-plot artifact GC (hermetic)
  d) scripts="v8 v10 v11 v12 v13 v14 v15 v16 v18 v19 v20 v21 v22 v23 v24 v25 v26 v28 v29 v30 v32"; label="VERIFY-D" ;;  # real VSCode end-to-end (network + xvfb); v32 also needs ruff/ty/ms-python installed
